  ...
  return (
    <header className="flex items-center justify-around border-2 py-[30px]">
      ...
      <nav className="hidden gap-5 md:flex">
        <Link href={'/'} className="font-medium text-green-500 hover:underline">HOME</Link>
        <Link href={'/cat'} className="font-medium text-green-500 hover:underline">CAT</Link>
        <Link href={'/dog'} className="font-medium text-green-500 hover:underline">DOG</Link>
        <Link href={'/cadastro'} className="font-medium text-green-500 hover:underline">CADASTRO</Link>
      </nav>
