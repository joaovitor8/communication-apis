...
export const CadastroUsers = () => {
  ...
  return (
    <form
      ...
      className="flex h-80 w-4/5 flex-col items-center justify-center space-y-3"
    >
      <div className="flex w-full items-center justify-center space-x-3">
        ...
        <input
          ...
          className="w-1/2 rounded-md border-0 py-1.5 pl-5 shadow-sm ring-1 ring-gray-300 sm:text-sm sm:leading-6"
        />
      </div>
      ...
      <div className="flex w-full items-center justify-center space-x-3">
        ...
        <input
          type="text"
          placeholder="Rua-n° / Cidade-Estado"
          required
